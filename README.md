...
### **AI-Powered Scanning**
Snap a photo of your fridge or pantry. The Gemini-powered vision pipeline identifies ingredients, estimates quantities, and determines freshness instantly, eliminating the need for manual data entry.
...
At the core of FridgeChef is the **Google Gemini 2.5 Flash** model.
- **Ingredient Detection**: Images are processed via the FastAPI backend and sent to Gemini with specialized multimodal prompts for identification and categorization.
...
2. **Environment**: `cp .env.example .env` and add your Google Gemini API Key.
